        ...
        [
            ...
            [
                ...
                "inputSchema": [
                    "type": "object",
                    "properties": [
                        "screenshot": ["type": "boolean", "description": "Include a PNG of the rendered page. Default false. Use it ONLY when the question is genuinely visual — layout, spacing, overlap, colour. For working out what to click, the elements list is cheaper and more precise."],
                        "elements": ["type": "boolean", "description": "Include the page's interactive elements as a numbered list — [e7] button \"Save changes\", [e12] textbox \"Email\" empty. Default true. Pass a ref straight to preview_do's selector to act on that exact element; no CSS guessing, no screenshot needed."],
            ...
            [
                ...
                "inputSchema": [
                    ...
                    "properties": [
                        ...
                        "selector": ["type": "string", "description": "What to act on. Best: a ref from preview_look's elements list ('e7') — exact, and it cannot match the wrong node. Also accepts a CSS selector ('button[type=submit]', '#search'), Playwright syntax (':has-text(…)', 'text=…', '>> nth=N'), or just the visible text of the thing. For press, the element to send the key to; omit to use whatever is focused."],
    ...
    private func handleToolCall(id: Any?, params: [String: Any]) async {
        ...
        do {
            ...
            case "preview_look":
                ...
                if let els = res["elements"] as? String, !els.isEmpty {
                    head += "\n\nYou can act on any of these by passing its ref as preview_do's selector:\n\(els)"
                }
